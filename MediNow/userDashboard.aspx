			  	...
			  	<div class="col-md-12">
				    ...
				    <div class="collapse navbar-collapse navbar-right" id="myNavbar">
				      <ul class="nav navbar-nav">
				        ...
				        <asp:Button ID="Button5" runat="server" BackColor="#4cb7a5" Text="Place Order" ForeColor="#ffffff" Height="44px" OnClick="dash"></asp:Button>
...
<asp:GridView ID="gv" runat="server" 
        ...
        <Columns>
         ...
         <asp:BoundField DataField="User_ID" HeaderText="User_ID" 
                SortExpression="Symptom" ItemStyle-Width="160"/>
                 <asp:BoundField DataField="Item" HeaderText="Item" 
                SortExpression="Disease" ItemStyle-Width="160"/>
                      <asp:BoundField DataField="Quantity" HeaderText="Quantity" 
                SortExpression="Disease" ItemStyle-Width="160"/>
                      <asp:BoundField DataField="Price_Per_Quantity" HeaderText="Price_Per_Quantity" 
                SortExpression="Disease" ItemStyle-Width="160"/>
