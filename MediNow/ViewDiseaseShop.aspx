<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewDiseaseShop.aspx.cs" Inherits="ViewDiseaseShop" %>
...
<body>
    ...
    <asp:Button ID="continue" runat="server" Text="Place Order" class="btn btn-form" style="margin-left:42%;margin-top:5%" OnClick="con"  Font-Bold="true" Font-Size="20px" ForeColor="#ffffff" ></asp:Button>
    </form>
</body>
</html>
