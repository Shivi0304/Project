<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSymptomShop.aspx.cs" Inherits="ViewSymptomShop" %>
...
<body>
  ...
  <center>   <asp:GridView ID="GridView1" runat="server"   AllowPaging="True" 
        ...
        <Columns>
            ...
            <itemtemplate>
                <asp:checkbox ID="cbSelect" GroupName="abc" CssClass="gridCB" runat="server" style="margin-left:20px;" Enabled="true" ></asp:checkbox>
            </itemtemplate>
        </asp:templatefield>
    ...
    <asp:Button ID="continue" runat="server" Text="Place Order" class="btn btn-form" style="margin-left:42%;margin-top:5%" OnClick="con" ></asp:Button>
    </form>
</body>
</html>
